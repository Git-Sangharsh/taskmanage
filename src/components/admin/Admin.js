...
const Admin = () => {
  ...
  const handleEnter = () => {
    ...
    axios
      .post("https://taskmanagebackend-bdus.onrender.com/admin", adminData, {
  ...
  return (
    <div className="admin">
      ...
      <div className="admin-wrapper">
        ...
        <button className="admin-enter" onClick={handleEnter}>
          Enter
        </button>
        <div className="first-page">
          <h1 className="route-signin" onClick={handleSignUpRoute}>
            SignUp
          </h1>
          <h1 className="route-admin" onClick={handleRootRoute}>
            SignIn
          </h1>
        </div>
      </div>
